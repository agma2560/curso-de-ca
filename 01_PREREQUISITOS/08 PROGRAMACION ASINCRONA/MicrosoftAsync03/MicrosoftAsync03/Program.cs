...
namespace AsyncBreakfast
{
    ...
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            // Iniciar la tarea de freír huevos. La tarea comienza a ejecutarse
            // inmediatamente, pero no esperamos su finalización todavía.
            Task<Egg> eggsTask = FryEggsAsync(2);

            // Iniciar la tarea de freír tocino. También comienza a ejecutarse
            // en paralelo con la tarea de los huevos.
            Task<Bacon> baconTask = FryBaconAsync(3);

            // Iniciar la tarea de tostar pan. También se ejecuta en paralelo.
            Task<Toast> toastTask = ToastBreadAsync(2);

            // --- FIN DE LA MODIFICACIÓN (primera parte) ---

            // Ahora 'await'amos las tareas que toman tiempo, una por una,
            // pero las tareas ya estaban en progreso desde antes.
